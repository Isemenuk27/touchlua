...
function cBase:Center()
    vec2sub( self.vPos, self.vSize[1] * .5, self.vSize[2] * .5 )
end

function cBase:LocalCenter()
    vec2sub( self.vLocalPos, self.vSize[1] * .5, self.vSize[2] * .5 )
end

function cBase:SetParent( gParent )
    return gui.parent( gParent, self )
end
...
function cBase:GetWidth( nM )
    return self.vSize[1] * ( nM or 1 )
end

function cBase:GetHeight( nM )
    return self.vSize[2] * ( nM or 1 )
end
...
function cBase:SetLocalPos( ... )
    vec2set( self.vLocalPos, ... )
end

function cBase:GetLocalPos()
    return self.vLocalPos
end

function cBase:GetSize( nMX, nMY )
    return self.vSize[1] * ( nMX or 1 ), self.vSize[2] * ( nMY or 1 )
end
